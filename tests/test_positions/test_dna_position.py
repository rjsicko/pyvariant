...
def test_to_cdna_dna_end_minus_strand(ensembl100):
    from_position = DnaPosition(
        contig_id="5", start=1253147, start_offset=0, end=1253149, end_offset=0, strand="-"
    )
    to_positions = []
...
def test_to_cdna_dna_end_plus_strand(ensembl100):
    from_position = DnaPosition(
        contig_id="13", start=32400266, start_offset=0, end=32400268, end_offset=0, strand="+"
    )
    to_positions = []
    assert ensembl100.to_cdna(from_position) == to_positions
...
def test_to_cdna_dna_negative_offset_into_intron_minus_strand(ensembl100):
    from_position = DnaPosition(
        contig_id="5", start=1294666, start_offset=-1, end=1294666, end_offset=-1, strand="-"
    )
    to_positions = []
    assert ensembl100.to_cdna(from_position) == to_positions
...
def test_to_cdna_dna_overlapping_genes_different_strands_minus_strand(ensembl100):
    from_position = DnaPosition(
        contig_id="6", start=31166302, start_offset=0, end=31166304, end_offset=0, strand="-"
    )
    to_positions = []
    assert ensembl100.to_cdna(from_position) == to_positions
...
def test_to_cdna_dna_positive_offset_normalized_plus_strand(ensembl100):
    from_position = DnaPosition(
        contig_id="5", start=1294771, start_offset=1, end=1294771, end_offset=2, strand="+"
    )
    to_positions = []
    assert ensembl100.to_cdna(from_position) == to_positions
...
def test_to_cdna_dna_positive_offset_out_of_intron_minus_strand(ensembl100):
    from_position = DnaPosition(
        contig_id="5", start=1294667, start_offset=1, end=1294667, end_offset=1, strand="-"
    )
    to_positions = [
        CdnaPosition(
            contig_id="5",
...
def test_to_cdna_dna_start_plus_strand(ensembl100):
    from_position = DnaPosition(
        contig_id="13", start=32315508, start_offset=0, end=32315510, end_offset=0, strand="+"
    )
    to_positions = []
    assert ensembl100.to_cdna(from_position) == to_positions
...
def test_to_dna_dna_negative_offset_into_intron_minus_strand(ensembl100):
    ...
    to_positions = [
        DnaPosition(
            contig_id="5", start=1294667, start_offset=0, end=1294667, end_offset=0, strand="-"
        )
    ]
    assert ensembl100.to_dna(from_position) == to_positions
...
def test_to_dna_dna_positive_offset_normalized_plus_strand(ensembl100):
    ...
    to_positions = [
        DnaPosition(
            contig_id="5", start=1294772, start_offset=0, end=1294773, end_offset=0, strand="+"
        )
    ]
    assert ensembl100.to_dna(from_position) == to_positions
...
def test_to_dna_dna_positive_offset_out_of_intron_minus_strand(ensembl100):
    ...
    to_positions = [
        DnaPosition(
            contig_id="5", start=1294666, start_offset=0, end=1294666, end_offset=0, strand="-"
        )
    ]
    assert ensembl100.to_dna(from_position) == to_positions
